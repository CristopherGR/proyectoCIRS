...
export class FormusuarioComponent implements OnInit {
  ...
  private buildForm(){
    this.form = this.formBuilder.group({
      ciUsuario: [0,[Validators.required,Validators.pattern(/^[0-9.]+$/), Validators.minLength(10),Validators.maxLength(10)]],
      nombres: ['', [Validators.required]],
      apellidos: ['', [Validators.required]],
      fechaNa: ['', [Validators.required]],
      direccion: ['', [Validators.required]],
      correo: ['', [Validators.required, Validators.email]],
      telefono: [0, [Validators.required],Validators.pattern(/^[0-9.]+$/), Validators.minLength(10), Validators.maxLength(10)],
